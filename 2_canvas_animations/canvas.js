...
class Circle {
    ...
    update() {
        ...
        if (this.y + this.radius > innerHeight || this.y - this.radius < 0) {
            this.dy = -this.dy;
            // change te color once it bounces
            this.color = getRandomColor();
        }
...
for (let i = 0; i < 100; i++) {
    ...
    let radius = Math.random()*(90-30)+30;
    ...
    let dx = (Math.random() - 0.5)*3; //-0.5 to generate negative number as random generates number between 0 and 1
